...
#include <windows.h>
using namespace std;
#define LEARNING_NUM 300000 //学習回数
#define SAMPLE_NUM 100	//サンプル数
#define INPUT_NUM 3	//入力層数
#define HIDDEN_NUM 10	//中間層数
#define OUTPUT_NUM 1	//出力層数
#define EPSILON 0.01	//重み修正定数
#define PATTERNS 3		//パターンの数 入力層数
#define rand() xor128()
